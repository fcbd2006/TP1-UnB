...
class Codigo : public Dominio{
    private:
         ...
         * @throw std::invalid_argument Caso a validação falhe.
    ...
    public:
         ...
         * @throw std::invalid_argument Caso o código fornecido seja inválido.
...
class Data : public Dominio{
    ...
    public:
         ...
         * @throw std::invalid_argument Caso a data fornecida seja inválida.
...
class Email : public Dominio{
    private:
         ...
         * @throw std::invalid_argument Caso a validação de formato falhe.
    ...
    public:
         ...
         * @throw std::invalid_argument Caso o email fornecido seja inválido.
...
class Estado : public Dominio{
    ...
    public:
         ...
         * @throw std::invalid_argument Caso o estado fornecido seja inválido.
...
class Nome : public Dominio{
    ...
    public:
         ...
         * @throw std::invalid_argument Caso o nome fornecido seja inválido.
...
class Papel : public Dominio{
    ...
    /**
         ...
         * @throw std::invalid_argument Caso o papel fornecido seja inválido.
         * Ao ser instanciado, o construtor repassa o valor recebido para 
...
class Prioridade : public Dominio{
    ...
    public:
         ...
         * @throw std::invalid_argument Caso a prioridade fornecida seja inválida.
...
class Senha : public Dominio{
    ...
    public:
         ...
         * @throw std::invalid_argument Caso a senha fornecida seja inválida.
         * Ao instanciar o objeto, o valor é repassado ao método setValor(), 
...
class Tempo : public Dominio{
    ...
    public:
         ...
         * @throw std::invalid_argument Caso o valor fornecido seja inválido.
         * Ao instanciar o objeto, o valor é repassado ao método setValor(), 
         * que aciona automaticamente a validação de 
...
class Texto : public Dominio{
    ...
    public:
         ...
         * @throw std::invalid_argument Caso o texto fornecido seja inválido.
         * Ao ser instanciado, o construtor repassa o valor recebido para 
         * o método setValor(), que automaticamente 
